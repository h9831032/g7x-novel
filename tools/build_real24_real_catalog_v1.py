"""
G7X REAL24 Real Catalog Builder v1
- REAL36을 축소한 24개 미션
- GPTORDER\REAL24_REAL_A.txt (24줄) 생성
"""
...
def main():
    ...
    # REAL24_REAL_A.txt 생성 (24개 실전 미션)
    missions = [
    ...
    output_file = gptorder_dir / "REAL24_REAL_A.txt"
    with open(output_file, "w", encoding="utf-8") as f:
        for mission in missions:
            f.write(mission + "\n")

    print(f"[CREATED] {output_file} ({len(missions)} missions)")
    print(f"[SUCCESS] REAL24_REAL_A.txt generated")
    return 0
